...
- **Sending highlights to a note app:** install the [Obsidian](/export-sync/obsidian/) or [SiYuan](/export-sync/siyuan/) plugin and create an export token in Acorny Settings.
